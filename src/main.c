...
static ssd1306_inst_t ssd_dev0 = { .i2c_dev	 = i2c1,
...
static ssd1306_inst_t ssd_dev1 = { .i2c_dev	 = i2c1,
								   .baudrate = I2C_BAUDRATE,
								   .sda_pin	 = SDA_PIN,
								   .scl_pin	 = SCL_PIN,
								   .addr	 = SSD_DEV1_ADDR,
...
int main(void)
{
	...
	xTaskCreate(usb_device_task, "USB", USB_TASK_STACK, NULL, USB_TASK_PRIO,
				NULL);
